...
//third - working with course prices
...
const courses = [
  { id: '1', name: 'Vocals Mixing Mastering Package' },
  { id: '2', name: 'BEGINNER YouTube Cover song shoot' },
  { id: '3', name: 'Audio podcast Per hour' },
  { id: '4', name: 'Recording Session Per Hour - Shure SM 58/ Scarlett' },
  { id: '5', name: 'Professional Cover songs Package' },
  { id: '6', name: 'Premium Room with Rode NT2 - Spacious' },
  { id: '7', name: 'Podcast Audio & Video Production Package - 4 Hours' },
  { id: '8', name: 'Clamat Acoustics Premium' },
  { id: '9', name: 'Intimate Sessions/karaoke sessions' },
  { id: '10', name: 'Jam sessions' },
  { id: '11', name: 'Guitar/Keyboard Drum Group Classes' },
  { id: '12', name: '10 hours Package for Jam Session' },
  { id: '13', name: 'Clamat Audio Release Service' },
  { id: '14', name: 'Audio podcast Per hour' },
  { id: '15', name: 'Karaoke Party Venue' },
  { id: '16', name: 'Music Classes - 3 Months' }
];
